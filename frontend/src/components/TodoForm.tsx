      ...
      <button
        ...
        {!loading &&
          ...
          <div role="status" className='mx-auto min-w-fit'>
            <svg aria-hidden="true" className="inline w-full h-full  text-transparent animate-spin dark:text-gray-600 fill-white" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
